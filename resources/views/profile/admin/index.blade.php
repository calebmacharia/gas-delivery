...
<section class="bg-gray-800 rounded-3xl dark:bg-gray-800 mx-auto md ">
        ...
        <form action="{{url('/uploadgas')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="sm:col-span-2">
                    <label for="image" class="block mb-2 text-sm font-medium text-white">Product image</label>
    ...
    <table class="min-w-full mt-5divide-y divide-gray-200 dark:divide-gray-700">
      ...
      <tbody class="divide-y divide-gray-200 bg-gray-800 dark:divide-gray-700">
        ...
        <tr>
          ...
          <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-white">{{$data->brand}}</td>
          <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{$data->type}}</td>
          <td class="px-6 py-4 whitespace-nowrap text-sm text-white">{{$data->size}}</td>
